...
RB.Carousel.prototype = {
    ...
    ***** CAROUSEL PUBLIC METHODS ****
    ...
    showSlide(index, callback, action) {
        ...
        var animate = function(timestamp) {
            ...
            if (runtime < this.transitionTime && this.currentSlideIndex === index) {
                ...
                if (typeof this.callbackOnslideShown === 'function' && this.callbackOnslideShown) {
                    this.callbackOnslideShown(this.currentSlideIndex);
                }
            }
    ...
    **** CAROUSEL PRIVATE METHODS ****
    ...
    __setupTouchEvents: function() {
        ...
        function dragAction(event) {
            ...
            _this.carouselInnerEl.style.marginLeft = (_this.carouselInnerEl.offsetLeft - xPosition2) + "px";
        ...
        function dragEnd(event) {
            ...
            if (posFinal - posInitial < -threshold) {
             _this.nextSlide();
              ...
              _this.carouselInnerEl.style.marginLeft = (posInitial) + "px";
            }
