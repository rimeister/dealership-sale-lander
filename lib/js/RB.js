    ...
    ***** CAROUSEL PUBLIC METHODS ****
    ...
    showSlide: function(index, callback, action) {
        ...
        if (this.allowSlide) {
            ...
            // Need to tell the slide how much further to move

            /*

            // this.carouselInnerEl.style.left = scrollTarget + "px";
            console.log(-1 * parseInt(this.positionInitial) + parseInt(scrollTarget) + 'px');

            this.carouselInnerEl.style.left = -1 * parseInt(this.positionInitial) + parseInt(scrollTarget) + 'px';

            this.carouselInnerEl.style.left = -1 * parseInt(this.positionInitial) + parseInt(scrollTarget) + 'px';

            console.log('this.positionInitial: '+parseInt(this.positionInitial));
            console.log('scroll target: '+parseInt(scrollTarget));
    ...
    checkIndex: function (){
        ...
        if (this.currentSlideIndexindex == -1) {
          this.carouselInnerEl.style.left = -(this.slides.length * slideWidth) + "px";
          this.currentSlideIndexindex = this.slides.length - 1;
        }

        if (this.currentSlideIndexindex == this.slides.length) {
          this.carouselInnerEl.style.left = -(1 * slideWidth) + "px";
          this.currentSlideIndexindex = 0;
        }
        */
