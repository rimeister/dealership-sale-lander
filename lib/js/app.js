...
NAMESPACE.Carousel.prototype = {
	...
	**** CAROUSEL PRIVATE METHODS ****
	...
	__setupNavigation: function() {
		...
		var leftBtn = this.el.getElementsByClassName('carousel-nav-btn-left')[0];
		var rightBtn = this.el.getElementsByClassName('carousel-nav-btn-right')[0];
	...
	__showNavigation: function() {
		// var carouselNav = this.el.getElementsByClassName('carousel-nav')[0];

		var carouselNavBtns = this.el.getElementsByClassName('carousel-nav-btn');
