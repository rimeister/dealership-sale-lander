...
APP.init = function(page) {
    ...
    if (page == 'home') {
        ...
        // Make the carousel always be 100% of the window height
        // This works better on mobile than height: 100vh
        ...
        carsCarouselEl.style.height = height + 'px';
        ...
        var testDriveForm = new RB.Form({
            ...
            onFormSubmit: function(formData,showSuccessMsg,showErrorMsg) {
                ...
                // TEMP: Just need this data for the placeholder endpoint I'm using
                formData = {
                  title: 'foo',
                  body: 'bar',
                  userId: 1
